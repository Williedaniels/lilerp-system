          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white px-8 py-3">
                ...
                Call Emergency Line: +231-123-HELP
              </Button>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Dial +231-123-HELP from any phone. Our voice system guides you through simple menu options in your preferred language.
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="p-6">
              ...
              <CardContent>
                <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm mb-4">
                  <div className="mb-2">📞 Calling +231-123-HELP...</div>
                ...
                <div className="text-center text-gray-600">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                    <div className="bg-blue-100 p-4 rounded-lg">
                      ...
                      <div className="text-sm">Voice IVR, Mobile App, Web</div>
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">+231-123-HELP (4357)</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
